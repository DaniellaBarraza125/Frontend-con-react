...
const PrintedProducts = () => {
    ...
    const { products, addCart, cart, addLike } = useContext(ProductsContext);
...
const handleAddToCart = (product) => {
    ...
    return (
        ...
        <div className="input-container">
            ...
            <input onChange={handleInputChange} className="inputSearch" type="text" name="text" placeholder="search..."/>
                ...
                return (
                    <div className="printedProductCard" key={i}>
                        ...
                        <div className="printedProductFfooter">
                            ...
                            <button className="likeBtn" onClick={() => addLike(product)}>
